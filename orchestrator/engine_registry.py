...
ENGINES: dict[str, EngineInfo] = {
    ...
    "xtts-v2": EngineInfo(
        ...
        description="Multilingual, clone-only, optional CUDA",
        size="~1.1GB",
        gpu=False,
    ...
    "f5-tts": EngineInfo(
        name="f5-tts",
        display_name="F5 TTS",
        description="Clone-only, auto-transcribes reference audio",
        size="~7.5GB",
        gpu=False,
        builtin_voices=False,
    ...
    "gpt-sovits": EngineInfo(
        ...
        description="Clone-only, auto-trims reference 3-10s",
        size="~5.3GB",
        gpu=False,
        builtin_voices=False,
    ...
    "cosyvoice2": EngineInfo(
        ...
        description="Zero-shot or cross-lingual voice synthesis",
        size="~5.8GB",
        gpu=False,
        builtin_voices=False,
